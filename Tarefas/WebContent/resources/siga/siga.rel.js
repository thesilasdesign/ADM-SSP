...
Siga.REL.Estabelecimento = function () {
    ...
    return {
        Selecionar: function (codigoTipoEstabelecimento, codigoEstabelecimentoSuperior, codigoEmpresa, indicadorEmpresa, indice, callback, incluirInativas, listaTipoUsoEstabelecimento) {
            var dto = {};
            dto.codigoTipoEstabelecimento = codigoTipoEstabelecimento;
            ...
            dto.listaTipoUsoEstabelecimento = (listaTipoUsoEstabelecimento == undefined? "1" : listaTipoUsoEstabelecimento);
        ...
        SelecionarParaUso: function (sender, codigoTipoEstabelecimento, codigoEstabelecimentoSuperior, codigoEmpresa, indicadorEmpresa, indice, callback , listaTipoUsoEstabelecimento, ativo) {
            var dto = {};
            dto.sender = sender;
            dto.codigoEmpresa = codigoEmpresa;
            dto.codigoTipoEstabelecimento = codigoTipoEstabelecimento;
            ...
            dto.indice = indice;
            dto.listaTipoUsoEstabelecimento = (listaTipoUsoEstabelecimento == undefined ? "1" : listaTipoUsoEstabelecimento);
            dto.ativo = (ativo == undefined && ativo != null ? true : ativo);
        ...
        SelecionarTipoEstabelecimento: function (listaTipoEstabelecimento, listaSuperior, validaAcesso, callback) {
            var dto = {};
            dto.listaTipoEstabelecimento = listaTipoEstabelecimento;
...
Siga.REL.PessoaFisica = function () {
    ...
    return {
        ...
        SelecionarInfinitoFormatadoIrmaoNaoCadastrado: function (campo, textoSelecione, listaDiacono, codigoEmpresa, codigoEstabelecimento, codigoPessoa, listaStatusCargo, ativo) {
            Siga.Widgets.Select2.SingleAjaxInfinite(
                campo,
                servico + "/SelecionarIrmaoNaoCadastrado",
                "* " + textoSelecione + " *",
                function (term, page) {
                    var dto = {};
                    dto.term = term;
