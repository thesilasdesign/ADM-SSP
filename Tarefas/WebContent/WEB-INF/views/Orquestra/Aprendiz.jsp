		...
		<div class="col-xs-12">
			...
			<div class="table-responsive">
				...
				<table id="dynamic-table"
					...
					<tbody>
						<c:forEach items="${aprendiz}" var="aprendiz">
							<tr>
								<td>${aprendiz.aprendizId}</td>
								<td>${aprendiz.comum}</td>
								<td>${aprendiz.nome}</td>
								<td>${aprendiz.instrumento}</td>
								<td>${aprendiz.celular}</td>
								<td>${aprendiz.oficializado}</td>
								<td><a href="RemoverAprendiz?id=${aprendiz.aprendizId}">Remover</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" name="comum" id="exampleModalLabel">Cadastro de Aprendizes</h4>
			</div>
			<div class="modal-body">
				<form action="CadastroAprendiz" name="cad" id="cad" method="post">
