		...
		<div class="col-xs-12">
			...
			<div class="table-responsive">
				...
				<table id="dynamic-table"
					...
					<tbody>
						<c:forEach items="${instrutor}" var="instrutor">
							<tr>
								<td>${instrutor.instrutorId}</td>
								<td>${instrutor.comum}</td>
								<td>${instrutor.nome}</td>
								<td>${instrutor.instrumento}</td>
								<td>${instrutor.celular}</td>
								<td>${instrutor.oficializado}</td>
								<td><a href="RemoverInstrutor?id=${instrutor.instrutorId}">Remover</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" name="comum" id="exampleModalLabel">Cadastro de Instrutores</h4>
			</div>
			<div class="modal-body">
				<form action="CadastroInstrutor" name="cad" id="cad" method="post">
