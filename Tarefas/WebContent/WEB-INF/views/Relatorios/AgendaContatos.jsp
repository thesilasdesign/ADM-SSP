			...
			<table id="dynamic-table"
				...
				<tbody>
					<c:forEach items="${contatos}" var="contatos">
						<tr>
							<td>${contatos.nome}</td>
							<td>${contatos.cargo}</td>
							<td>${contatos.comum}</td>
							<td>${contatos.telefone}</td>
							<td>${contatos.celular}</td>
							<td>${contatos.email}</td>
							<td class="center"><a class="red"
								href="AgendaRemove?id=${contatos.agendaId}"> <i
									class="ace-icon fa fa-trash-o bigger-130"></i>
							</a>&nbsp;&nbsp;&nbsp; <a class="red"
								href="AgendaEdita?id=${contatos.agendaId}"> <i
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="CadastrarAgenda" name="cad" id="cad" method="post">
					...
					<div class="form-group">
						<label for="recipient-name" class="control-label">Cargo:</label><br>
						<select name="cargo" class="form-control">
							<option>AUXILIAR JURÍDICO</option>
							<option>AUXILIAR PATRIMÔNIO</option>
							<option>AUXILIAR PIEDADE</option>
							<option>AUXILIAR SECRETÁRIA</option>
							<option>AUXILIAR TESOURARIA</option>
							<option>COMPRADOR</option>
							<option>CONSELHO FISCAL</option>
							<option>CONTADOR</option>
							<option>ENGENHARIA</option>
							<option>MANUTENÇÃO/COMPRA</option>
							<option>PATRIMÔNIO</option>
							<option>PRESIDENTE</option>
							<option>PROJETISTA</option>
							<option>TECNICO ENFERMAGEM</option>
							<option>TECNICO SEGURANÇA</option>
					...
					<div class="form-group">
						<label for="recipient-name" class="control-label">Email:</label> <input
							type="text" class="form-control" id="recipient-name" name="email"
							placeholder="central@ccb.com.br">
					</div>
