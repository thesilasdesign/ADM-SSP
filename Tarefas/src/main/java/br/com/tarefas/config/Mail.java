...
public class Mail {
	...
	public void sendEmailSenhaNova(String Nome, String email, String titulo, String Pedido, String msg1, String msg2)
		...
		email1.setFrom("sistema@jandiraccb.com.br", "Informatica - Jandira CCB");
		email1.setSubject(titulo);

		email1.setHtmlMsg("<html>\n" + "<body>\n" + "<h1> " + msg1 + "</h1>\n" + "<h2> " + msg2 + "</h2>\n"
				+ "<p>Mensagem enviada pelo Sistema "
				+ "ADM jandira <a href=\"http://www.jandiraccb.com.br\"><b>JandiraCCB!</b></a></p>\n" + "</body>\n"
				+ "</html>");
		...
		email1.setAuthentication("sistema@jandiraccb.com.br", "123@iniciar");
		// envia o e-mail
		email1.send();
	...
	public void sendEmailInformatica(String Nome, String email, String titulo, String Pedido, String msg1, String msg2,
		...
		email1.setSmtpPort(465);
		email1.addTo(email, Nome);
		email1.addCc("renato.ulisses@congregacao.org.br", "Renato Ulisses");
		email1.addCc("oliveirasabo@gmail.com", "Marco Sabo");
		email1.setFrom("thesilasdesign@gmail.com", "Informática - Jandira CCB");
		email1.setSubject(titulo);
	...
	@SuppressWarnings("deprecation")
	public void sendEmailEquipeCompras(List<String> emails, String Nome, String email, String titulo, String Pedido, String msg1,
		...
		for (int i = 0; i < emails.size(); i++) {
			email1.addCc(emails.get(i));
		}
		email1.addCc("thesilasdesign@gmail.com", "Silas Oliveira");
		email1.setFrom("sistema@jandiraccb.com.br", "Informática - Jandira CCB");
		email1.setSubject(titulo);
	...
	public void sendEmailCompraAprovacao(String Nome, String email, String titulo, String Pedido, String msg1,
		...
		email1.addCc("thesilasdesign@gmail.com", "Silas Oliveira");
		email1.setFrom("sistema@jandiraccb.com.br", "InformÃ¡tica - Jandira CCB");
		email1.setSubject(titulo);
